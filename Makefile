...
FLAGS = -std=c++11 -lcublas -gencode arch=compute_70,code=sm_70 -gencode arch=compute_80,code=sm_80 -res-usage -lcudart -L/home/heyuanhong/usr/fftw/lib/ -lfftw3 -lcufft -lineinfo -Xcompiler -fopenmp -I/home/heyuanhong/usr/fftw/include/
